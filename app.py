...
path = st.sidebar.text_input("📂 Укажите путь к CSV-файлу", "data/data_hw5.csv")
...
# Оценка моделей
st.write("### 📈 ROC-кривые")
roc_auc_df, fprs, tprs, aucs = evaluate_models(models, X_test[top2].values, y_test.values)
